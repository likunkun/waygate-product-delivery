...
[![Version](https://img.shields.io/badge/version-1.0.29-0f766e)](plugins/waygate-product-delivery/.codex-plugin/plugin.json)
...
```text
dist/waygate-product-delivery-1.0.29.tar.gz
```
